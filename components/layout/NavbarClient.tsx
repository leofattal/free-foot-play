            ...
            {user ? (
              <>
                ...
                <button
                  ...
                  disabled={loading}
                  className="text-gray-700 hover:text-primary transition-colors disabled:opacity-50"
                >
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white border-t border-gray-200">
          <div className="px-4 pt-2 pb-4 space-y-2">
            ...
            {user ? (
              <>
                <Link href="/dashboard" className="block py-2 text-gray-700 hover:text-primary transition-colors">
                  Dashboard
                </Link>
                <button
                  onClick={handleLogout}
                  disabled={loading}
                  className="block w-full text-left py-2 text-gray-700 hover:text-primary transition-colors disabled:opacity-50"
                >
                  {loading ? 'Logging out...' : 'Logout'}
                </button>
              </>
